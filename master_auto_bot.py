...
async def process_scene(scene_id, text, image_prompt):
    ...
    cmd_stitch = [
        ...
        "-vf", f"drawtext={font_clause}text='{safe_text}':fontcolor=yellow:fontsize=65:x=(w-text_w)/2:y=(h-text_h)/2:line_spacing=25:box=1:boxcolor=black@0.7:boxborderw=25:borderw=3:bordercolor=black",
