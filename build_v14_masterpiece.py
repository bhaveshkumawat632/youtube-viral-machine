...
OUTPUT_DIR = "/home/junglee01/youtube-viral-machine/output_v14"
...
def run():
    ...
    # Extract 15s with its ORIGINAL audio!
    ...
    # Run SMART DIRECTOR to get the flawless 9:16 tracking
    ...
    # FINAL MIX WITH ORIGINAL AUDIO AND UNSHARP EQ
    final_cmd = (
        ...
        f"{OUTPUT_DIR}/DEMO_V14_FINAL_TEST.mp4"
    )
