...
OUTPUT_DIR = "/home/junglee01/youtube-viral-machine/output_v15"
...
def run():
    ...
    track_cmd = f"python3 hardcut_director.py {raw_wide} | ffmpeg -y -f rawvideo -pix_fmt bgr24 -s 1080x1920 -r {fps} -i pipe:0 -c:v libx264 -preset fast -crf 17 {tracked_bg}"
    ...
    final_cmd = (
        ...
        f"{OUTPUT_DIR}/DEMO_V15_HARDCUT.mp4"
    )
